...
export function MovieCard({ movie }) {
  ...
  return (
    <>
      ...
      <figure className="p-4 border border-black/10 shadow-lg dark:border-white/10 rounded-xl">
        <div
          className={`${
            ...
            <div className="flex justify-between gap-4 items-center flex-wrap">
              {!movie.isComingSoon && (
                <div className="flex flex-1 justify-center items-center">
                  <button
                    className="bg-primary py-2 px-5 flex items-center justify-center gap-2 text-[#171923] font-semibold  border-2 border-primary rounded-md text-sm w-full min-w-48"
                    onClick={(e) => {
                      e.preventDefault();
                      e.stopPropagation();
              ...
              {!movie.isComingSoon && (
                <div className="flex justify-center gap-4 flex-1">
                  <button
                    className="py-2 px-5 flex items-center justify-center border-2 border-primary rounded-md text-sm "
                    onClick={(e) => {
                      e.preventDefault();
                      e.stopPropagation();
              ...
              {movie.isComingSoon && (
                <div className="flex flex-1 justify-center items-center">
                  <button
                    className="comingSoon bg-gray-500 py-2 px-5 flex items-center justify-center gap-2 text-[#171923] font-semibold  border-2 border-gray-500 rounded-md text-sm w-full min-w-48 cursor-not-allowed"
                    disabled
                    onClick={(e) => {
                      e.preventDefault();
                    }}
