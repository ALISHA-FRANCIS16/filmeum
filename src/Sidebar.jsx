    ...
    <>
      <aside className="">
        <ul className="space-y-2">
          <li>
            <div className="mt-4">
              <input
                ...
                value={search}
                placeholder="search"
                className="w-full p-2 py-2 rounded-md border-2 border-primary focus:outline-none text-black "
                onChange={(e) => {
                  e.preventDefault();
                  e.stopPropagation();
          ...
          <li>
            <a
              className={`flex cursor-pointer items-center space-x-2 px-5 py-3.5 rounded-md ${
          ...
          <li>
            <a
              className={`flex items-center space-x-2 px-5 py-3.5 rounded-md cursor-pointer ${
